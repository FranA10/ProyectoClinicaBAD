   ...
   <div class="col-md-12">
      <div class="card card-success">
         <div class="card-header">
            <h3 class="card-title">Datos de Examen</h3>
         </div>
         <!-- /.card-header -->
         <div class="card-body">
               ...
               <div class="row">
                  <div class="col-3">
                     <div class="form-group">
                        ...
                        <input type="text"  id="nombre" disabled value="{{$objeto->nombre_examen}}" name="nombre" class="form-control" placeholder="Enter ...">
                     </div>
                  </div>
                  <div class="col-3">
                     <div class="form-group">
                        <label>Tipo examen</label>
                        <input type="text" value="{{$objeto->nombre_tipo_examen}}" disabled  id="nombre" name="nombre" class="form-control" placeholder="Enter ...">
                     </div>
                  </div>
                  <div class="col-3">
                     <div class="form-group">
                        <label>Fecha asignación</label>
                        <input type="text" disabled value="{{ date("d/m/Y",strtotime($objeto->fecha_asignacion))}}"  id="nombre" name="nombre" class="form-control" placeholder="Enter ...">
                     </div>
                  </div>
                  <div class="col-3">
                     <div class="form-group">
                        <label>Fecha recibido</label>
                        <input type="text" disabled value="{{ date("d/m/Y",strtotime($objeto->fecha_resultado))}}"  id="nombre" name="nombre" class="form-control" placeholder="Enter ...">
                     </div>
                  </div>
                  <div class="col-3">
                     <div class="form-group">
                        <label>Hora recibido</label>
                        <input type="text" disabled value="{{ date("d/m/Y",strtotime($objeto->hora_resultados))}}"  id="nombre" name="nombre" class="form-control" placeholder="Enter ...">
                     </div>
                  </div>
                  <div class="col-12">
                     <div class="form-group">
                        <label>Observación</label>
                        <textarea class="form-control" disabled rows="3" placeholder="Enter ...">{{$objeto->observacion}} </textarea>
                     </div>
                  </div>
               </div>
               <div class="row">
